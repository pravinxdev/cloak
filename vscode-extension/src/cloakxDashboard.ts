...
export class CloakxDashboard {
  public static currentPanel: CloakxDashboard | undefined;
  private readonly _panel: vscode.WebviewPanel;
  private readonly _extensionUri: vscode.Uri;
  private _disposables: vscode.Disposable[] = [];
  private _onDidChangeViewState = new vscode.EventEmitter<void>();
  ...
  public updateStatus(isAuthenticated: boolean, secretCount: number = 0) {
    this._panel.webview.html = this._getHtmlForWebview(isAuthenticated, secretCount);
  }

  private _getHtmlForWebview(isAuthenticated: boolean = false, secretCount: number = 0): string {
    return `<!DOCTYPE html>
			<html lang="en">
			<head>
				<meta charset="UTF-8">
