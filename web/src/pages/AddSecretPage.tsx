...
// import { useApp, type Secret } from "@/contexts/AppContext";
...
//   const { secrets, addSecret, updateSecret } = useApp();
//   const navigate = useNavigate();
//   const { id } = useParams();

//   const existing: Secret | undefined = id ? secrets.find((s) => s.id === id) : undefined;
...
//     }
//     if (isEdit) {
//       updateSecret(existing!.id, key, value);
...
//           {isEdit ? "Update the key-value pair below." : "Add a new key-value pair to your vault."}
//         </p>
//       </div>
